...
class TagihanPageController extends GetxController
    implements PaginationControllerInterface {
  static TagihanPageController get to => Get.find();
  ...
  Future<void> fetchItems() async {
    page += 1;
    PaginateResponse response = await TagihanApi.fetchTagihan(page: page);
